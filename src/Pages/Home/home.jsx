...
function Home() {
  ...
  return (
    <div className='border-black border-x-2'>
      ...
      <section id="work" className={`px-4 pb-12 border-black border-t-2 bg-white-600 ${backgroundImage ? 'bg-fixed' : ''}`} 
        style={backgroundImage ? { backgroundImage: `url(${backgroundImage})` } : { backgroundColor: '#6366f1' }}>
          ...
          <div className='grid md:grid-cols-2 gap-8 mb-28'>
            {portfolioData.map((item, index) => (
              <a key={index} target='_blank' href={item.link} rel='noopener noreferrer'
                className='md:even:pt-12 ease-in-out duration-75 block
        ...
        <div className='container mx-auto px-4 py-12'>
          ...
          <p className='max-w-xl mx-auto text-lg '>
            ...
            <div className='text-black py-12 grid lg:grid-cols-4 item-center '>
              ...
              <div className='flex justify-center mb-12 md:mb-0 col-span-2 object-none'>
                <LazyImage 
                  src={BoyImage} 
                  alt="Blogs" 
              ...
              <div>
                <h3 className='text-xl font-bold mb-4'>Daizy Night</h3>
                <p className='mb-4 '>
